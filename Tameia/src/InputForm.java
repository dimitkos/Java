...
public class InputForm extends JFrame {
	...
	public InputForm(ArrayList<Tameio> tameia) {
		...
		eponimoField = new JTextField("eponimo");
		AFMField= new JTextField("AFM");
		posostoField = new JTextField("pososto:0.0-0.99");
		eisodhmaField = new JTextField("eisodhma");
		childrenField = new JTextField("children");
		ergazomenosRadio = new JRadioButton("misthotos");
		syntaxRadio = new JRadioButton("syntax");
